...
import { createAccessibilityTools } from '../tools/accessibility/accessibilityTools.js';
...
import { createMonitorTools } from '../tools/system/monitorTools.js';
...
export function getToolDefinitions(context: ServerContext): ToolDefinition<any, unknown>[] {
  return [
    ...
    ...createAccessibilityTools(context)
  ];
}
